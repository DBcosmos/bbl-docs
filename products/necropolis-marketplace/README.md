...
Necropolis operates with the [GraveDiggers](../bassets-and-minting-tokens/gravedigger-lsts/) bASSETs at its heart. By integrating bASSETs, Necropolis allows users to maximize their capital, earning yield while participating in NFT transactions. This dual functionality—trading NFTs and generating yield—sets Necropolis apart from traditional NFT marketplaces.
